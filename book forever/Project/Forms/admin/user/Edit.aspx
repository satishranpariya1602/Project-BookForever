...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminBody" runat="Server">
    ...
    <div class="Form">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
            <asp:Label ID="lblEmail" runat="server" Text="E-mail Id" AssociatedControlID="txtEmail" SkinID="lbl"></asp:Label>
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="txtpass" runat="server" placeholder="Enter date of birth" SkinID="txt"></asp:TextBox>
        </div>

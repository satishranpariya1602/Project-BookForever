...
<asp:Content ID="Content2" ContentPlaceHolderID="AdminBody" runat="Server">
    <div class="Form">
        ...
        <asp:GridView
            ...
            <Columns>
                <asp:BoundField DataField="Bid" HeaderText="id" ReadOnly="True" SortExpression="id" InsertVisible="False" />
        ...
        <asp:SqlDataSource ID="IndexDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [byer]" ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>"></asp:SqlDataSource>
    </div>
</asp:Content>

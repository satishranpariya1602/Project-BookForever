<%@ Page Title="" Theme="Theme" Language="C#" MasterPageFile="~/Forms/Masters/Visitor.master" AutoEventWireup="true" CodeFile="searchedbooksub.aspx.cs" Inherits="Forms_Visitor_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VisitorBody" runat="Server">
    ...
    <div class="auto-style6 col-md-12   " style="text-align: center; height: 634px; margin-top: 20px;">
           ...
           <asp:DataList ID="DataList1" runat="server" CellPadding="0" CellSpacing="50" DataKeyField="Id" DataSourceID="SqlDataSource1" RepeatColumns="4" RepeatDirection="Horizontal" Width="910px" Height="500px">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Books] WHERE ([sub_categoery] = @sub_categoery)">
                <SelectParameters>
                    <asp:SessionParameter Name="sub_categoery" SessionField="book" Type="String" />

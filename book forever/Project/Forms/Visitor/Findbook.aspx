<%@ Page Title="" Theme="Theme" Language="C#" MasterPageFile="~/Forms/Masters/Visitor.master" AutoEventWireup="true" CodeFile="Findbook.aspx.cs" Inherits="Forms_Visitor_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="VisitorBody" runat="Server">
    ...
    <div class="col-md-12">
     ...
     <div class="col-md-12">
   <div class="col-md-5"> &nbsp &nbsp</div>
    <div class="col-md-6">
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   <div class="col-md-5"> </div>
    <div class="col-md-7">
        ...
        <asp:Button ID="Button1" runat="server" Text="Search" SkinID="btn" style="align-items:center" OnClick="Button1_Click"/>    
    </div>
    </div>

...
public partial class Forms_Visitor_Default : System.Web.UI.Page
{
    ...
    protected void btnbuy_Click(object sender, EventArgs e)
    {
        ...
        string msg = "dear " + s + " i shown your" + book + " book to sell contact me:" + contact;
        ...
        {
            Interaction.MsgBox("Error while send msg");
        }
    ...
    protected void btnexchange_Click(object sender, EventArgs e)
    {
        ...
        string book = dt.Rows[0]["sub_categoery"].ToString();
        string contact = dt2.Rows[0]["contact"].ToString();
        string msg = "dear " + s + " i shown your " + book + " book to exchange contact me:" + contact;
